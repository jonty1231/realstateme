...
export default function Hero() {
  ...
  const citiesData = [
    ...
    "Chandigarh", "Solapur", "Hubballi-Dharwad", "Bareilly", "Mysore",
    ...
    "Tirunelveli", "Malegaon", "Gaya", "Udaipur", "Maheshtala"
  ];
                ...
                <div className='hidden lg:block'> 
                  ...
                  <div className="relative flex justify-center  border-r-2  ">
                    <input
                      ...
                      className="w-full px-4 py-2  rounded-[200px]    focus:outline-none pr-10"
                    />
                    <span
